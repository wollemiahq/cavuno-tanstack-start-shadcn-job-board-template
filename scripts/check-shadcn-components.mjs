...
This standalone starter owns the complete shadcn Base Rhea source set generated by \`${report.installCommand}\`. The machine-readable [usage ledger](./shadcn-component-usage.json) records every production import so humans and LLMs can distinguish an installed primitive from one the product currently needs.
