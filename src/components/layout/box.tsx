...
type BoxBorder = "none" | "all" | "top" | "right" | "bottom" | "left" | "x" | "y";
...
export type BoxProps<Element extends LayoutElement = "div"> = LayoutProps<Element, BoxOwnProps>;
...
export function Box<Element extends LayoutElement = "div">({
  ...
  const layoutStyle = {
    ...
    ...(paddingX ? responsiveTokenStyle("layout-padding-x", paddingX, spaceValues) : {}),
    ...(paddingY ? responsiveTokenStyle("layout-padding-y", paddingY, spaceValues) : {}),
  };
