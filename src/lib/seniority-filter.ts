 ...
 *
 * The `/jobs` seniority control is the in-tree Untitled UI `MultiSelect`,
...
export function seniorityFromSelection(keys: Selection): Seniority[] | undefined {
    const list = keys === "all" ? [...SENIORITIES] : ([...keys] as Seniority[]);
    return list.length > 0 ? list : undefined;
}

/** The controlled `Selection` for the active `seniority` filter. */
export function selectionFromSeniority(seniority: Seniority[] | undefined): Selection {
