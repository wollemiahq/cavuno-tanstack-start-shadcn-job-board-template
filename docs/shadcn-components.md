...
| `badge` | Used (38) | `src/components/alert-manager.tsx`<br>`src/components/board/blog-article-content.tsx`<br>`src/components/board/blog-tag-chips.tsx`<br>+35 more in the JSON ledger |
