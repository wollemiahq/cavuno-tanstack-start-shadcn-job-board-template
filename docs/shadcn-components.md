...
- Production adoption: 39 used, 21 available.
...
| `alert-dialog` | Used (2) | `src/components/danger-zone.tsx`<br>`src/components/preview/preview-toolbar.tsx` |
...
| `avatar` | Used (12) | `src/components/Header.tsx`<br>`src/components/account-shell.tsx`<br>`src/components/avatar-upload.tsx`<br>+9 more in the JSON ledger |
| `badge` | Used (39) | `src/components/alert-manager.tsx`<br>`src/components/board/blog-article-content.tsx`<br>`src/components/board/blog-tag-chips.tsx`<br>+36 more in the JSON ledger |
